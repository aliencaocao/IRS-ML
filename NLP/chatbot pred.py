...
print('Tokenized sample question: {}'.format(tokenizer.encode(parent_df[20])))
...
optimizer = tf.keras.optimizers.Adam(learning_rate, beta_1=0.8, beta_2=0.9, epsilon=1e-9)
...
while True:
    sentence = input("Type in question: ")
    predict(sentence)
